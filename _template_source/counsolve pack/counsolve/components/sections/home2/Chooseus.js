    ...
    return (
        <>
            ...
            <section className="chooseus-style-two sec-pad">
                <span className="big-text">benefits</span>
                ...
                <div className="inner-container">
                    ...
                    <div className="chooseus-block-two">
                        ...
                        <p>Foresee the pain trouble that rationally encounter</p>
                        </div>
                    </div>
                    <div className="chooseus-block-two">
                        <div className="inner-box">
                    ...
                    <div className="chooseus-block-two">
                        ...
                        <p>One rejects, dislikes, or avoids pleasure itself</p>
                        </div>
                    </div>
                    <div className="chooseus-block-two">
                        <div className="inner-box">
